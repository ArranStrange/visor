...
// Per-camera feature and film simulation exceptions now live with the
// compatibility service that reads them; re-exported here because dial-in
// and its tests have always imported them from this module.
export {
  CAMERA_FEATURE_OVERRIDES,
  CAMERA_SIM_OVERRIDES,
} from "@/features/compatibility/cameraOverrides";
