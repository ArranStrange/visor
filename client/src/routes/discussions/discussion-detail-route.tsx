...
import DiscussionDetailBreadcrumb from "./discussion-detail.runtime";
import {
  CREATE_POST,
  DELETE_POST,
  UPDATE_POST,
} from "@gql/mutations/discussions";
import {
  CREATE_REPLY,
  UPDATE_REPLY,
  DELETE_REPLY,
} from "@gql/mutations/replyMutations";
